...
const useDesktopPicker = ({
  ...
  const _useSlotProps = (0, _utils.useSlotProps)({
    ...
    inputAdornmentProps = (0, _objectWithoutPropertiesLoose2.default)(_useSlotProps, _excluded);
  ...
  const _useSlotProps2 = (0, _utils.useSlotProps)({
    ...
    openPickerButtonProps = (0, _objectWithoutPropertiesLoose2.default)(_useSlotProps2, _excluded2);
